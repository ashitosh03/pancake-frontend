...
const minimumLacToRegister = new BigNumber(REGISTER_COST).multipliedBy(DEFAULT_TOKEN_DECIMAL)
...
const UserName: React.FC = () => {
  ...
  const { teamId, selectedNft, userName, actions, minimumLacRequired, allowance } = useProfileCreation()
  ...
  const hasMinimumLacRequired = useHasLacBalance(minimumLacToRegister)
  const [onPresentConfirmProfileCreation] = useModal(
    <ConfirmProfileCreationModal
      ...
      account={account}
      teamId={teamId}
      minimumLacRequired={minimumLacRequired}
      allowance={allowance}
    />,
    false,
  )
